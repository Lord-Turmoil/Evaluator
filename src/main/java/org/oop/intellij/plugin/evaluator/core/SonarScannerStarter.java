...
import org.oop.intellij.plugin.evaluator.common.exceptions.ConfigException;
...
import org.oop.intellij.plugin.evaluator.messages.AnalysisAbortingListener;
...
//        indicator.setText("Execute Sonar Scan on [" + project.getName() + "]");
		try {
			if (!configCompleted()) {
